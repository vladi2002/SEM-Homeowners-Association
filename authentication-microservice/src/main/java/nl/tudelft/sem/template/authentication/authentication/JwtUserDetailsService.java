...
import nl.tudelft.sem.template.authentication.domain.user.UsernameNotAllowedException;
...
public class JwtUserDetailsService implements UserDetailsService {
     ...
     */
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, UsernameNotAllowedException {
        var optionalUser = userRepository.findAppUserByNetId(new NetId(username));
